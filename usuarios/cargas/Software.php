...
if (!file_exists('Diseño de Software')) {
  ...
  if (file_exists('Diseño de Software')) {
    ...
    if (file_exists('Diseño de Software/' . $num_control . $nombre)) {
      ...
      if (move_uploaded_file($guardado, 'Diseño de Software/' . $num_control . $nombre)) {

        $inserta = "INSERT INTO evidencia(numero_control, id_evento, subido, ruta_doc) VALUES ('$num_control', '$id_act', 1, 'Diseño de Software/$num_control$nombre')";
